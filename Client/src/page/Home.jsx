  ...
  return (
    <>
      ...
      <div className="relative flex flex-col items-center min-h-screen pt-20 px-4 sm:px-6 md:px-8 overflow-hidden">
        <div className="absolute inset-0 -z-10 h-full w-full bg-linear-to-br from-gray-50 via-white to-indigo-50/30">
          ...
          {/* Ultra fine grid - Responsive size */}
        ...
        <div className="relative flex items-end justify-center w-full max-w-6xl mx-auto">
          <div className="relative flex flex-col sm:flex-row items-center sm:items-baseline justify-center gap-2 sm:gap-0">
            <div className="relative text-center sm:text-right">
              <span className="font-[350] text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] tracking-[-0.02em] text-gray-900">
            ...
            {/* THE SLASH - Dramatically emphasized - Responsive sizing */}
            ...
            <div className="relative text-center sm:text-left">
              <div className="inline-block relative">
                <span className="font-[350] text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] tracking-[-0.02em] text-gray-800">
                ...
                {!timeData ? (
                  ...
                  >
                    <div className="relative">
                      ...
                      {/* Animated sparkle dots - Blue theme */}
                  ...
                  <div className="absolute -top-5 -right-12 md:-right-16 flex gap-1.5 sm:gap-2">
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="relative w-7 h-7 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-11 lg:h-11 bg-blue-500 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110">
                          {/* Glow effect */}
                          <div className="absolute inset-0 bg-blue-400 rounded-full blur-sm sm:blur-md opacity-0 group-hover:opacity-60 transition-all duration-500 group-hover:scale-125"></div>

                          {/* Animated sparkle dots - Hidden on smallest screens */}
                          <div className="hidden sm:block absolute -top-1 -right-1">
                            <Sparkles className="w-2 h-2 sm:w-2.5 sm:h-2.5 text-blue-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-spin" />
                          </div>

                          {/* The pen icon - Smaller sizing */}
                          <Pen className="relative w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 lg:w-5 lg:h-5 text-white transition-all duration-300 group-hover:rotate-12 stroke-[1.5]" />
                        </div>
                      </div>
                    </button>
            ...
            <div className="mt-2 sm:mt-0 sm:ml-10 md:ml-6 mb-6 sm:mb-7 md:mb-8">
              <span className="font-extralight text-gray-500 text-lg sm:text-xl md:text-2xl tracking-widest uppercase">
                hrs
              </span>
            </div>
          </div>
        ...
        {/* Subtle connecting line - Responsive */}
        ...
        {!timeData?.data?.history?.quote ? (
          <div className="mt-12 sm:mt-14 md:mt-16 max-w-xs sm:max-w-sm md:max-w-md px-4 text-center">
            <p className="font-light text-gray-500 text-sm sm:text-base md:text-lg leading-relaxed tracking-wide">
              Every hour tells a story. This is yours.
            </p>
          </div>
        ) : (
          <div className="mt-12 sm:mt-14 md:mt-16 max-w-xs sm:max-w-sm md:max-w-md px-4 text-center">
        ...
        <div className="mt-16 sm:mt-18 md:mt-20 flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center w-full max-w-md sm:max-w-lg px-4">
          ...
          <button className="group relative w-full sm:w-auto">
            ...
            {/* Main button - Responsive padding */}
            <div className="relative w-full px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-full bg-white/90 backdrop-blur-sm border border-gray-200/50 group-hover:border-fuchsia-200 transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl sm:group-hover:shadow-2xl group-hover:shadow-fuchsia-500/20">
              <span className="relative flex items-center justify-center gap-2 sm:gap-3 font-light text-gray-700 group-hover:text-fuchsia-600 text-base sm:text-lg tracking-wide">
                <Download className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 group-hover:animate-bounce" />
                <span className="truncate">Download</span>
              </span>
            </div>
          </button>

          {/* Logs button - Responsive */}
          <button className="group relative w-full sm:w-auto">
        ...
        {/* Todo */}
        {/* PROGRESS - Responsive */}
        <div className="mt-16 sm:mt-18 md:mt-20 w-full max-w-xs sm:max-w-sm px-4">
          <div className="flex justify-between font-light text-gray-400 text-xs sm:text-sm tracking-wide mb-2 sm:mb-3">
            <span>Progress</span>
            <span className="text-fuchsia-500">40%</span>
          </div>

          {/* Ultra thin progress bar - Responsive height */}
          <div className="h-px sm:h-[1.5px] bg-gray-200/50 rounded-full overflow-hidden">
            <div
              className="h-full bg-linear-to-r from-fuchsia-400 to-pink-400 transition-all duration-1000 ease-out"
              style={{ width: "40%" }}
            >
              {/* Animated glow on progress */}
              <div className="absolute top-0 right-0 w-3 sm:w-4 h-full bg-linear-to-r from-transparent via-white/30 to-transparent animate-[shimmer_2s_infinite]"></div>
            </div>
          </div>
              ...
              <div key={dot} className="relative">
                <div
                  className={`w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full ${
                    dot <= 40 ? "bg-fuchsia-400" : "bg-gray-300/30"
                  }`}
                />
                {dot === 40 && (
                  <div className="absolute -top-0.5 -left-0.5 sm:-top-1 sm:-left-1 w-2 h-2 sm:w-3 sm:h-3 rounded-full border border-fuchsia-400/30 animate-ping"></div>
                )}
              </div>
            ))}
          </div>
